...
async function Navbar_dashboard() {
    return (
        <div className="navbar">
            <Image src={require("../../public/assets/Logo-UJED 1.png")} alt="Logo" width={220} height={87}/>
            <h1>Areas certificadas</h1>
            <button onClick={() => {signOut();}} className="cursor-pointer inline-flex items-center rounded-full px-9 py-3 text-xl font-mono font-semibold text-white hover:text-white border-2 border-white
