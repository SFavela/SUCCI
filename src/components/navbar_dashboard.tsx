...
function Navbar_dashboard() {
    return (
        <div className="navbar">
            ...
            <Link href="/login"><button onClick={() => {signOut();}} className="cursor-pointer inline-flex items-center rounded-full px-9 py-3 text-xl font-mono font-semibold text-white hover:text-white border-2 border-white
